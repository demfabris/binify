...
/// credits: https://docs.rs/dotenv/0.15.0/src/dotenv/parse.rs.html
...
pub fn from_file(path: &OsStr) -> Result<Iter> {
    Ok(Iter::new(fs::File::open(path).map_err(Error::Io)?))
}
